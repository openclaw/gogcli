...
### Added
- Auth: `--access-token` flag and `GOG_ACCESS_TOKEN` env var for direct access token authentication. Enables headless/CI usage without browser-based OAuth or keyring access. (#TBD) — thanks @mmkal.
