...
- **Formatting Sheets with fewer calls.** [Persisted structural batches](sheets-batch-update.md#persisted-structural-batches) reuse one base metadata snapshot and submit queued edits atomically.
