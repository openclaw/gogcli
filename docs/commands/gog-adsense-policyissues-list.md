...
```bash
gog adsense policyissues (policyissue) list (ls) <account> [flags]
```

## Parent

- [gog adsense policyissues](gog-adsense-policyissues.md)
...
| `--max`<br>`--limit` | `int64` | 50 | Max policy issues per page |
