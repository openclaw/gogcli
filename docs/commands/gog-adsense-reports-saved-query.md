# `gog adsense reports saved query`
...
```bash
gog adsense reports (report) saved query (run,generate) <name> [flags]
```
...
| `--timezone` | `string` |  | Reporting timezone (e.g. America/Los_Angeles) |
