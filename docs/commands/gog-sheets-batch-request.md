# `gog sheets batch-request`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

Submit an atomic structural request array (requires confirmation or --force)

## Usage

```bash
gog sheets (sheet) batch-request --requests-json=STRING <spreadsheetId> [flags]
```
...
| `--requests-json` | `string` |  | Structural requests as a JSON array, or @file/@- |
