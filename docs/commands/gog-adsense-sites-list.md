# `gog adsense sites list`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

List AdSense sites for an account

## Usage

```bash
gog adsense sites list (ls) <account> [flags]
```

## Parent

- [gog adsense sites](gog-adsense-sites.md)
...
| `--max`<br>`--limit` | `int64` | 50 | Max sites per page |
