# `gog adsense adunits linkedcustomchannels`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

List custom channels linked to an ad unit

## Usage

```bash
gog adsense adunits (adunit) linkedcustomchannels (customchannels) <adunit> [flags]
```

## Parent

- [gog adsense adunits](gog-adsense-adunits.md)
...
| `--max`<br>`--limit` | `int64` | 50 | Max custom channels per page |
