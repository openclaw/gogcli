...
```bash
gog adsense adclients (adclient) list (ls) <account> [flags]
```

## Parent

- [gog adsense adclients](gog-adsense-adclients.md)
...
| `--max`<br>`--limit` | `int64` | 50 | Max ad clients per page |
