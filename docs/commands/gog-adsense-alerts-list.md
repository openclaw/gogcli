...
```bash
gog adsense alerts list (ls) <account> [flags]
```

## Parent

- [gog adsense alerts](gog-adsense-alerts.md)
...
| `--language`<br>`--lang` | `string` |  | Language code for alert messages (e.g. en-US) |
