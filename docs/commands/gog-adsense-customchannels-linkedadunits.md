# `gog adsense customchannels linkedadunits`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

List ad units linked to a custom channel

## Usage

```bash
gog adsense customchannels (customchannel) linkedadunits (adunits) <customchannel> [flags]
```

## Parent

- [gog adsense customchannels](gog-adsense-customchannels.md)
...
| `--max`<br>`--limit` | `int64` | 50 | Max ad units per page |
