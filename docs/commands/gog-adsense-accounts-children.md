# `gog adsense accounts children`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

List child accounts of a manager account

## Usage

```bash
gog adsense accounts (account) children (list-children) <parent> [flags]
```

## Parent

- [gog adsense accounts](gog-adsense-accounts.md)
...
| `--max`<br>`--limit` | `int64` | 50 | Max accounts per page |
