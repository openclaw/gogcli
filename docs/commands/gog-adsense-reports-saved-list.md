# `gog adsense reports saved list`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

List saved reports for an account

## Usage

```bash
gog adsense reports (report) saved list (ls) <account> [flags]
```

## Parent

- [gog adsense reports saved](gog-adsense-reports-saved.md)
...
| `--max`<br>`--limit` | `int64` | 50 | Max saved reports per page |
