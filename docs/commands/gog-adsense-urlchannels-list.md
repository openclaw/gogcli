# `gog adsense urlchannels list`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

List URL channels for an ad client

## Usage

```bash
gog adsense urlchannels (urlchannel) list (ls) <adclient> [flags]
```

## Parent

- [gog adsense urlchannels](gog-adsense-urlchannels.md)
...
| `--max`<br>`--limit` | `int64` | 50 | Max URL channels per page |
